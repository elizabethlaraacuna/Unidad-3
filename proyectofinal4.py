...
# 3°B Programa T.M
# programa que me ayuda a realizar mi proyecto de ventas
...
def abrir_reportes():
    ...
    # Mostrar total general abajo de la tabla
    ...
    lbl_total_general.pack(pady=10)
...
# BOTONES PRINCIPALES
# -------------------------
# Usamos tk.Button en lugar de ttk.Button para poder personalizar colores
def crear_boton(ventana, texto, comando):
    return tk.Button(ventana, text=texto, command=comando, 
                     bg="pink", fg="black", font=("Bodoni MT Black", 12), width=20, height=2)

btn_reg_prod = crear_boton(ventana, "Registro de Productos", abrir_registro_productos)
btn_reg_prod.pack(pady=10)

btn_reg_ventas = crear_boton(ventana, "Registro de Ventas", abrir_registro_ventas)
btn_reg_ventas.pack(pady=10)

btn_reportes = crear_boton(ventana, "Reportes", abrir_reportes)
btn_reportes.pack(pady=10)

btn_acerca = crear_boton(ventana, "Acerca de", abrir_acerca_de)
